...
class TaskDataset(Dataset):
    ...
    def download_dataset(num_workers=4):
        ...
        try:
            ...
            if num_workers <= 1:
                ...
                args_list = [
                    (subset, secrete, shared_progress) for subset in subject_ids_subsets
                ]
    ...
    def _download_subset(args):
        subject_ids_, secrete_, shared_progress = args
        TaskDataset._print_progress(progress=shared_progress)
        TaskDataset._download_dataset(
            subject_ids=subject_ids_, secrete=secrete_, progress=shared_progress
        )
